...
if text_model_name == 'bert':
    model_path1 = '../weights/bert-base-uncased'
    ...
    model_path1 = "../weights/roberta-base"
    config1 = AutoConfig.from_pretrained(model_path1)
    ...
    model_path1 = "../weights/roberta-large"
    config1 = AutoConfig.from_pretrained(model_path1)
    text_pretrained_dict = RobertaForTokenClassification.from_pretrained(model_path1).state_dict()
...
if image_model_name == 'vit':
    model_path2 = "../weights/vit-base-patch16-224-in21k"
    ...
    model_path2 = "../weights/vit-large-patch16-224"
    config2 = AutoConfig.from_pretrained(model_path2)
    image_pretrained_dict = ViTForImageClassification.from_pretrained(model_path2).state_dict()
elif image_model_name == 'swin':
    model_path2 = "../weights/swin-tiny-patch4-window7-224"
    config2 = AutoConfig.from_pretrained(model_path2)
...
# init ICTModel
vb_model = ICTModel(config1,config2,text_num_labels=5,text_model_name=text_model_name,image_model_name=image_model_name,alpha=alpha,beta=beta)
...
trainer = Trainer(   # 826行，修改了数据加载方式
    model=vb_model,
    args=training_args,
