...
class TrainInputProcess:
    ...
    def generate_dualc_input(self):
        for dataset_type in self.dataset_types:
            ...
            with open("datasets/finetune/dualc/{}/input_{}.txt".format(self.nianfen, dataset_type), "w", encoding="utf-8") as file:  
                for item in images_path:  
                    # 将每个元素逐行写入文件，并在末尾添加换行符  
                    file.write(item + "\n")
...
def main():
    ...
    if text_model_type == 'bert':
        ...
        # text_model = '../weights/roberta-base'
        text_model = '../weights/roberta-large'
        # text_model = '../weights/twitter-roberta-base-sentiment-latest'

    if image_model_type == 'vit':
        # image_model = '../weights/vit-base-patch16-224-in21k'
        # image_model = '../weights/vit-base-patch16-224'
        image_model = '../weights/vit-large-patch16-224'
        # image_model = '../weights/deit-base-patch16-224'
    ...
    if finetune_task == 'im2t':
        ...
        if image_gen_model_type == 'ved':
            image_gen_text_model = '../weights/vit-gpt2-image-captioning'
        elif image_gen_model_type == 'blip':
            image_gen_text_model = '../weights/blip-image-captioning-base'
    ...
    if dataset_type == '2015':
        data_text_dir = '/home/IJCAI2019_data/twitter2015'
        data_image_dir = '/home/IJCAI2019_data/twitter2015_images'
    elif dataset_type == '2017':
        data_text_dir = '/home/IJCAI2019_data/twitter2017'
        data_image_dir = '/home/IJCAI2019_data/twitter2017_images'
